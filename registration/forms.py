...
class RegistrationForm(UserCreationForm):
    ...
    first_name=forms.CharField(help_text=_(u'First name'),
        required=True
    )
    last_name=forms.CharField(help_text=_(u'Last name'),
        required=True)
    email = forms.EmailField(
        help_text=_(u'email address'),
        required=True
    )
    #photo=forms.ImageField(help_text=_(u'Photo'),required=False)
