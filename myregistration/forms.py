...
class RegistrationForm(UserCreationForm):
    ...
    password1=forms.CharField(min_length=6,label=(u'Password'),widget=forms.PasswordInput(render_value=False))
    password2=forms.CharField(min_length=6,label=(u'Verify Password'),widget=forms.PasswordInput(render_value=False))
